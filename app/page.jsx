...
export default function Home() {
  ...
  return (
    <main className='w-[100dvw] h-[100dvh] relative overflow-x-hidden'>
      ...
      <div className="w-[40px] h-[340px] fixed bottom-0 left-14 flex flex-col justify-end items-center gap-8">
        <ul className="flex flex-col gap-8">
          <li>
            <a href="https://github.com/4llay/" target="_blank">
              <i className="fa-brands fa-github text-slate-200 text-[2.5rem]"></i>
            </a>
          </li>
          <li>
            <a href="https://www.youtube.com/channel/UCwhsQvCUR5HpnLbJiqFNY6Q" target="_blank">
              <i className="fa-brands fa-youtube text-slate-200 text-[2.2rem]"></i>
            </a>
          </li>
          <li>
            <a href="https://www.instagram.com/joaopaulodcg/" target="_blank">
            <i class="fa-brands fa-instagram text-slate-200 text-[2.7rem]"></i>
            </a>
          </li>
        </ul>
      ...
      {/* barra email(direita) */}
      <div className="w-[40px] h-[340px] fixed bottom-0 right-14 flex flex-col justify-end items-center gap-[7.4rem]">
      ...
      <div className="w-full h-full fixed top-0 z-[-1] backdrop-blur-[150px]" />
    </main>
  )
}
