    ...
    return (
        <div className="flex textShadow text-slate-200 flex-col justify-center">
            ...
            <div className="flex flex-col gap-8 items-center">
                <p className="text-slate-400 w-[500px] text-center">Estou sempre em busca de novas oportunidades e colaborações. Se você tem um projeto em mente ou gostaria de conversar, entre em contato! Será um prazer responder!</p>
