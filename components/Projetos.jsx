...
export default function Projetos() {
    return (
        <div className="flex textShadow text-slate-200 flex-col gap-8 justify-center">
            ...
            <div className="bg-slate-800 aspect-[2/1] relative w-[700px] rounded-2xl overflow-hidden projetos">
                <div className="w-[55%] h-[100%] pt-4 pb-7 px-5 flex items-center flex-col leading-relaxed gap-2">
                    ...
                    <ul className="mt-10 flex flex-wrap gap-2 sm:mt-auto">
                ...
                <img src="/cs.jpeg" className="absolute aspect-[2/1] w-[500px] rounded-2xl right-[-30%] top-[13%]"></img>
            </div>
            
            <div className="bg-slate-800 aspect-[2/1] relative flex  w-[700px] rounded-2xl overflow-hidden projetos justify-end">
                <div className="w-[55%] h-[100%] pt-4 pb-7 px-5 flex items-center flex-col leading-relaxed gap-2">
                ...
                <img src="/logoPro.png" className="absolute w-[350px] rounded-2xl left-[-2%] top-0"></img>
            </div>
        </div>
    )
}