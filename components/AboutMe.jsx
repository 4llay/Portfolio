    ...
    return (
        <div className="flex flex-col textShadow">
            <div className="text-white flex items-center gap-24">
                <div className="flex flex-col gap-2 w-[60dvw] lg:w-[40dvw]">
                    <Titulo number={"01."} title={"Sobre mim"}/>
                    <div className="text-[0.8rem] sm:text-[1.2rem] text-balance flex flex-col gap-8">
                ...
                <div className="w-[400px] aspect-[10/16] lg:block hidden">
                <ImageHolder>
